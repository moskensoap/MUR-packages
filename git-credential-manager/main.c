...
int main(int argc, char *argv[])
{
    ...
    // Replace "/bin/git-credential-manager" with "/share/mur__git-credential-manager/git-credential-manager"
    char *binPath = "/bin/git-credential-manager";
    char *realPath = "/share/mur__git-credential-manager/git-credential-manager";
