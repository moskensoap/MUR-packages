...
int main(int argc, char *argv[]) {
    ...
    // Replace "/bin/$(fileName)11" with "/share/java/mur__jdk11-openjdk/bin/$(fileName)"
    char binPath[PATH_MAX], realPath[PATH_MAX];
    sprintf(binPath, "/bin/%s11", fileName);
    sprintf(realPath, "/share/java/mur__jdk11-openjdk/bin/%s", fileName);
