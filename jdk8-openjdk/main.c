...
int main(int argc, char *argv[])
{
    ...
    // Replace "/bin/$(fileName)8" with "/share/java/mur__jdk8-openjdk/bin/$(fileName)"
    char binPath[PATH_MAX], realPath[PATH_MAX];
    sprintf(binPath, "/bin/%s8", fileName);
    sprintf(realPath, "/share/java/mur__jdk8-openjdk/bin/%s", fileName);
