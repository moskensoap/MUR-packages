...
int main(int argc, char *argv[])
{
    ...
    // Replace "/bin/$(fileName)jrelatest" with "/share/java/mur__jre-openjdk/bin/$(fileName)"
    char binPath[PATH_MAX], realPath[PATH_MAX];
    sprintf(binPath, "/bin/%sjrelatest", fileName);
    sprintf(realPath, "/share/java/mur__jre-openjdk/bin/%s", fileName);
