...
int main(int argc, char *argv[]) {
    ...
    // Replace "/bin/$(fileName)jre11" with "/share/java/mur__jre11-openjdk/bin/$(fileName)"
    char binPath[PATH_MAX], realPath[PATH_MAX];
    sprintf(binPath, "/bin/%sjre11", fileName);
    sprintf(realPath, "/share/java/mur__jre11-openjdk/bin/%s", fileName);
