...
int main(int argc, char *argv[])
{
    ...
    // Replace "/bin/$(fileName)jre17" with "/share/java/mur__jre17-openjdk/bin/$(fileName)"
    char binPath[PATH_MAX], realPath[PATH_MAX];
    sprintf(binPath, "/bin/%sjre17", fileName);
    sprintf(realPath, "/share/java/mur__jre17-openjdk/bin/%s", fileName);
