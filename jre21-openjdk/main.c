...
int main(int argc, char *argv[])
{
    ...
    // Replace "/bin/$(fileName)jre21" with "/share/java/mur__jre21-openjdk/bin/$(fileName)"
    char binPath[PATH_MAX], realPath[PATH_MAX];
    sprintf(binPath, "/bin/%sjre21", fileName);
    sprintf(realPath, "/share/java/mur__jre21-openjdk/bin/%s", fileName);
