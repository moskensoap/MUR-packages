...
int main(int argc, char *argv[]) {
    ...
    // Replace "/bin/$(fileName)jre8" with "/share/java/mur__jre8-openjdk/bin/$(fileName)"
    char binPath[PATH_MAX], realPath[PATH_MAX];
    sprintf(binPath, "/bin/%sjre8", fileName);
    sprintf(realPath, "/share/java/mur__jre8-openjdk/bin/%s", fileName);
