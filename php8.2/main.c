...
int main(int argc, char *argv[])
{
    ...
    // Replace "/bin/$(fileName)" with "/share/mur__php8.2/$(fileName)"
    char binPath[PATH_MAX], realPath[PATH_MAX];
    sprintf(binPath, "/bin/%s8.2", fileName);
    sprintf(realPath, "/share/mur__php8.2/%s", fileName);
    ...
    // cp path to confpath and replace /share/mur__php8.2/$(fileName) with /share/mur__php8.2/conf.d
    char confPath[PATH_MAX];
    strcpy(confPath, path);
    sprintf(binPath, "/share/mur__php8.2/%s", fileName);
    sprintf(realPath, "/share/mur__php8.2/%s", "conf.d");
    ...
    // cp path to userconfpath and replace /opt/share/mur__php8.2/$(fileName) with /home/.mur/php8.2
    char userConfPath[PATH_MAX];
    strcpy(userConfPath, path);
    sprintf(binPath, "/opt/share/mur__php8.2/%s", fileName);
    sprintf(realPath, "%s", "/home/.mur/php8.2");
